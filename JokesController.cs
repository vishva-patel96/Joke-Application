...
namespace JokeApplication.Controllers
{
    ...
    {
        private readonly JokeApplicationContext _context;

        public JokesController(JokeApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'JokeApplicationContext.Joke'  is null.");
            }
            var joke = await _context.Joke.FindAsync(id);
            if (joke != null)
            {
